        ...
        <Marker position={RSU_COORDS} icon={createUniversityIcon(isDark)}>
          <Popup className="custom-popup" closeButton={false}>
            <div
              ...
              style={{
                background: isDark ? "hsl(220 15% 10%)" : "white",
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      <span
                        ...
                        style={{ color: isDark ? "#c8ff00" : "#5a8f00" }}
                      >
                        {listing.category}
                      </span>
                    ...
                    >
                      ...
                      <span className="text-xs font-mono opacity-40 transition-colors">
                        View {"->"}
                      </span>
                    </div>
                  </div>
